    ...
    def _execute_add_to_outfit(self, arguments: dict, session) -> ToolResult:
        ...
        try:
            ...
            category_map = {
                ...
                'сумку': 'сумки и аксессуары', 'сумка': 'сумки и аксессуары',
                'туфли': 'обувь', 'босоножки': 'обувь', 'обувь': 'обувь', 'кроссовки': 'обувь', 'балетки': 'обувь'
            }
...
- "другую обувь" → add_to_outfit(item_type="обувь", replace_slot="shoes")
- "добавь сумку" → add_to_outfit(item_type="сумку")

## ПРОФИЛЬ ПОЛЬЗОВАТЕЛЯ
Учитывай параметры пользователя (фигура, цветотип, типаж Кибби), если они переданы.
"""
